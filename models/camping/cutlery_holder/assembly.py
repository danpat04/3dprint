"""cutlery_holder — 조립: 통(holder) + S후크 2개.
...
from models.camping.cutlery_holder.holder import build_holder
from models.camping.cutlery_holder.hook import build_hook
from models.camping.cutlery_holder.params import HOOK_X
